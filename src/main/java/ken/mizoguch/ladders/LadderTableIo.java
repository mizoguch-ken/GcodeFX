...
public class LadderTableIo {
     ...
     * @param address
     */
    public LadderTableIo(String address) {
        this(address, "", 0.0);
    }
     ...
     * @param comment
     */
    public LadderTableIo(String address, String comment) {
     ...
     * @param value
     */
    public LadderTableIo(String address, double value) {
        this(address, "", value);
    }
     ...
     * @param value
     */
    public LadderTableIo(String address, String comment, double value) {
